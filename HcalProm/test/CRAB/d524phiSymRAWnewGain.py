...
#process.GlobalTag.globaltag = autoCond['com10'] #mc
...
process.es_pool = cms.ESSource("PoolDBESSource",  
     ...
     cms.PSet(
              ...
              tag = cms.string("HcalRespCorrs_v4.2_offline")),
     ),
     connect = cms.string('frontier://FrontierProd/CMS_COND_31X_HCAL'),
     authenticationMethod = cms.untracked.uint32(0),
)
process.es_pool1 = cms.ESSource("PoolDBESSource",
                                process.CondDBSetup,
                                timetype = cms.string('runnumber'),
                                toGet = cms.VPSet(
     cms.PSet(
             record = cms.string('HcalGainsRcd'),
             tag = cms.string('HcalGains_5.06_test')),
     ),
     connect = cms.string('frontier://FrontierPrep/CMS_COND_HCAL'),
     authenticationMethod = cms.untracked.uint32(0),
)
process.es_prefer_es_pool = cms.ESPrefer( "PoolDBESSource", "es_pool")
process.es_prefer_es_pool1 = cms.ESPrefer( "PoolDBESSource", "es_pool1")
...
process.phaseHF = cms.EDAnalyzer ("phiSymRAW",
...
process.source.lumisToProcess = LumiList.LumiList(filename = '/uscms_data/d2/vodib/phisym524/Cert_190456-196531_8TeV_PromptReco_Collisions12_JSON.txt').getVLuminosityBlockRange()
